...
export const deleteProduct = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `http://localhost:5000/api/v1/admin/product/${id}`, { withCredentials: true }
    );
...
export const getProductDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `http://localhost:5000/api/v1/product/${id}`, { withCredentials: true }
    );
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `http://localhost:5000/api/v1/reviews?id=${id}`, { withCredentials: true }
    );
...
export const deleteReviews = (reviewId, productId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `http://localhost:5000/api/v1/reviews?id=${reviewId}&productId=${productId}`, { withCredentials: true }
    );
